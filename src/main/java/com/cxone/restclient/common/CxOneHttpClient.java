 ...
 */
public class CxOneHttpClient implements Closeable {
    ...
    public CxOneHttpClient(String rootUri, String origin, boolean disableSSLValidation, boolean isSSO, String refreshToken,
    ...
    public CxOneHttpClient(String rootUri, String origin, String originUrl, boolean disableSSLValidation, boolean isSSO, String refreshToken,
                        boolean isProxy, @Nullable ProxyConfig proxyConfig, Logger log, Boolean useNTLM) throws CxClientException {
    ...
    public TokenLoginResponse generateToken(LoginSettings settings) throws IOException {
        ...
        try {
            ...
            ClientType.RESOURCE_OWNER.setScopes("ast_rest_api");
    ...
    private StringEntity generateSSOEntity() {
        final String clientId = "cxoneast_client";
        ...
        final String scopes = "ast_api openid ast-permissions access-control-permissions access_control_api management_and_orchestration_api".replace(" ", "%20");
    ...
    public String getLanguageFromAccessToken() {
        ...
        try {
            ...
            // In case the AST used will not have token, set to default English language
