...
<div id="cx-report" class="cx-report">
                                            ...
                                            <span class="bar-1" id="osa-bar-critical"
                                                ...
                                                <div id="osa-tooltip-critical">
                                                    <#if config.osaThresholdsEnabled && config.osaCriticalThreshold??>
                                                        <@thresholdTooltip threshold=config.osaCriticalThreshold count=dependencyResult.criticalVulnerability/>
                                                    </#if>
                                                </div>
                                            </span>
    ...
    <#if ( config.isOsaEnabled() || config.isAstScaEnabled()) && dependencyResult.resultReady>
        <#if dependencyResult.dependencyHighCVEReportTable?size gt 0 || dependencyResult.dependencyMediumCVEReportTable?size gt 0 || dependencyResult.dependencyLowCVEReportTable?size gt 0 || dependencyResult.dependencyCriticalCVEReportTable?size gt 0>
